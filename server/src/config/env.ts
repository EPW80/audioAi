...
const envSchema = z.object({
  ...
  // Stable Video Diffusion (SVD) tuning
  AI_SVD_MODEL: z.string().default('stability-ai/stable-video-diffusion:3f0457e4619daac51203dedb472816fd4af51f3149fa7a9e0b5ffcf1b8172438'),
  AI_SVD_NUM_FRAMES: z.string().default('25'),
  AI_SVD_MOTION_BUCKET: z.string().default('127'),
  AI_SVD_FPS: z.string().default('7'),
  AI_SVD_TIMEOUT_MS: z.string().default('300000'),
});
